...
if __name__ == "__main__":
    arguments = docopt(
        __doc__,
        version="1.0")
    features_file = arguments["<features>"] # "../../data/ENCODE_ftp/label_names.txt"
    # http://hgdownload.soe.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeOpenChromDnase/
    ENCODE_DNase = arguments["<ENCODE-DNase>"] #"../../data/ENCODE_ftp/DNAse/"
    # http://hgdownload.soe.ucsc.edu/goldenPath/hg19/encodeDCC/wgEncodeAwgTfbsUniform/
    ENCODE_TF = arguments["<ENCODE-TF>"] #"../../data/ENCODE_ftp/TFChip/"
    # https://egg2.wustl.edu/roadmap/data/byFileType/peaks/consolidated/narrowPeak/
    Roadmap_Epi = arguments["<Roadmap>"] # "../../data/Selene/chromatin_profiles/Roadmap_Epigenomics/"
    ...
    full_aggregate_file = pd.concat(
        [DNase_agg, ChIP_agg, EID_agg], ignore_index=True) # deleted the EID_agg bit here, as we don't have the Roadmap Epigenomics right now
